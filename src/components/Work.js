      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row gap-x-10">
          ...
          className="flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0">
            <div>
              ...
              <p className="max-w-sm mb-16">
                ...
                to grow in this field. I have work on my own projects that can
                be seen on my github
              </p>
              <button className="btn btn-sm">View All Project</button>
              <a href="https://github.com/gpatarkalashvili1" className="text-gradient btn-link"> See My Github profile</a>
            </div>
          ...
          className="flex-1 flex flex-col gap-y-10"> 
            ...
            <div className="group relative overflow-hidden border-2 border-white/50 rounded-x1 mt-auto">
              <div className="group-hover:bg-black/70 w-full h-full absolute z-40 transition-all duration-300"></div>
              <img
                className="group-hover:scale-125 transition-all duration-500"
                src={Img3}
